...
export default function Header() {
  return (
    <div className="sticky top-0 z-10 flex min-h-24 cursor-pointer items-center space-x-4 border-b bg-background/90 px-8 text-muted-foreground backdrop-blur">
